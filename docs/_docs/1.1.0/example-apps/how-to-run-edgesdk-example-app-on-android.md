...
First download and install the [edgeSDK for Android](/docs/1.1.0/installation/android.html) on to the mobile device you will test with
...
Press dock to deploy the [example microservice](/docs/1.1.0/microservices/how-to-deploy-example-microservice.html) to this device
