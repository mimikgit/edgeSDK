...
Press dock to deploy the [example microservice](https://developer.mimik.com/docs/1.2.0/microservices/how-to-deploy-example-microservice.html) to this device
...
- [mimik serverless JavaScript programming API](https://developer.mimik.com/docs/1.2.0/resources/how-to-use-mimik-serverless-javascript-programming-api.html)
